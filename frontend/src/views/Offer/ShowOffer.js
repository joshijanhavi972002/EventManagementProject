            ...
            <Card>
                <Grid container spacing={2} style={{ marginBottom: "20px" }}>
                    <Grid item style={{ display: 'flex', justifyContent: "space-between", alignItems: "flex-start" }}>
                        <Button onClick={() => { navigate("/dashboard/offer") }} size='small' style={{ margin: "9px", color: "black" }}><AiOutlineArrowLeft /></Button>
                        <Typography style={{ margin: "9px", marginLeft: "-15px" }} variant='h5'>Offer # 1/2024
                        </Typography>
                    ...
                    <Grid item xs={9} style={{ display: 'flex', justifyContent: "end", alignItems: "end", textAlign: "end", }}>
                        <Button onClick={() => { navigate("/dashboard/offer") }} style={{ margin: "5px", color: "black", borderColor: "black", }} variant='outlined'><AiOutlineCloseCircle style={{ margin: '3px', marginLeft: "-3px" }} /> Close</Button>
                        ...
                        <Button onClick={() => { navigate("/dashboard/offer/update/1") }} style={{ margin: "5px" }} variant='contained'><AiOutlineEdit style={{ margin: '3px', marginLeft: "-3px" }} /> Edit</Button>
                    </Grid>
                </Grid>
                ...
                <Grid spacing={3} style={{ margin: "10px", padding: "10px" }}>
                    <Typography style={{ marginBottom: "20px" }} variant='h4'>lead: Aman</Typography>
