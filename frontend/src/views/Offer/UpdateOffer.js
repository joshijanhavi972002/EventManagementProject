            ...
            <Card>
                <Grid container spacing={2} style={{ marginBottom: "20px" }}>
                    <Grid item style={{ display: 'flex', justifyContent: "space-between", alignItems: "flex-start" }}>
                        ...
                        <Typography style={{ margin: "9px", marginLeft: "-15px" }} variant='h5'>Update</Typography>
                    ...
                    <Grid item xs={9} style={{ display: 'flex', justifyContent: "end", alignItems: "end", textAlign: "end", }}>
                        <Button onClick={() => { navigate("/dashboard/offer") }} style={{ margin: "5px", color: "black", borderColor: "black", }} variant='outlined'><AiOutlineCloseCircle style={{ margin: '3px', marginLeft: "-3px" }} /> Cancel</Button>
                        <Button style={{ margin: "5px" }} variant='contained'><AiOutlinePlus style={{ margin: '3px', marginLeft: "-3px" }} /> Update</Button>
                    </Grid>
                </Grid>
                <Divider orientation='horizontal' />
                <Grid container spacing={2} style={{ display: "flex", justifyContent: "space-between", padding: "10px", }}>
                    <Grid item xs={12} md={3} lg={3}>
                        <FormLabel required>Lead</FormLabel>
