...
// const handleWishUser=()=>{
//   navigate("/dashboard/Events/AddWishUser");
// }
// -----------------------------------------------------------------------
...
const WishUserList = () => {
  ...
  return (
    <>
      ...
      <WishUser open={openAdd} handleClose={handleCloseAdd} mode={mode} data={rowData} categories={categories} />
      <Container>
        <Stack direction="row" alignItems="center" mb={5} justifyContent={'space-between'}>
          <Typography variant="h4">Join Event List</Typography>
          <Stack direction="row" alignItems="center" justifyContent={'flex-end'} spacing={2}>
            <Button variant="contained" startIcon={<Iconify icon="eva:plus-fill" />} onClick={() => { handleCreateCategory() }}>
              Create Add Event Member
            </Button>
          </Stack>
        </Stack>
