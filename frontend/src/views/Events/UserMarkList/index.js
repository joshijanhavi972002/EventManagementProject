...
const UserMarkList = () => {
  ...
  const handleCreateCategory = () => {
    navigate('/dashboard/UserMark/CreateUserMark');
  }
          ...
          <Table sx={{ minWidth: 700 }} aria-label="customized table">
            <TableHead>
              <TableRow>
                ...
                <StyledTableCell >Gain Type</StyledTableCell>
                <StyledTableCell >Gain Coin&nbsp;</StyledTableCell>
            ...
            <TableBody>
              {categories.map((row) => (
                <StyledTableRow key={row.name}>
                  ...
                  <StyledTableCell >{row.Gain_Type}</StyledTableCell>
                  <StyledTableCell >{row.Gain_Coin}</StyledTableCell>
