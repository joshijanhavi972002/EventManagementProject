...
const CategoryList = () => {
  ...
  const handleCreateCategory = () => {
    navigate('/dashboard/EventCategory/CreateCategory');
  }
  ...
  return (
    <>
      ...
      <CategoryListDrawer open={openAdd} handleClose={handleCloseAdd} mode={mode} data={rowData} categories={categories} />
      <Container>
