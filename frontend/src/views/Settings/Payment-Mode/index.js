...
const documentData = [
    {
        id: 1,
        payment_mode: 'Autre',
        description: 'Autre mode de payement',
        default: "false",
        enabled: "true"
    }
];
const PaymentMode = () => {
                    ...
                    <>
                        ...
                        </Button>
                        {
                            ...
                            >
                                ...
                                <Typography id="delete" onClick={() => { setPaymentMode(params.row.payment_mode); handleClose(); handleClickOpen() }} sx={{ p: 1, cursor: "pointer" }}><AiOutlineDelete /> Delete</Typography>
                            </Popover> : null
                        }
                    </>
    ...
    return (
        <>
            <PaymentModeDrawer open={openAdd} handleClose={handleCloseAdd} mode={mode} data={rowData} />

            <Container>
                <Stack direction="row" alignItems="center" mb={5} justifyContent={'space-between'}>
                    <Typography variant="h4">Payment Mode List</Typography>
            ...
            >
                ...
                <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                        Are you sure you want to delete : {paymentMode}
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
