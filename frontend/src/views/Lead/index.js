...
const Lead = () => {
          ...
          <>
            ...
            </Button>
            {
              ...
              >
                ...
                <Typography id="delete" onClick={() => { setLeadName(params.row.name); handleClose(); handleClickOpen() }} sx={{ p: 1, cursor: "pointer" }}><AiOutlineDelete /> Delete</Typography>
  ...
  return (
    <>
      <LeadDrawer open={openAdd} handleClose={handleCloseAdd} mode={mode} data={rowData} />
      <Container>
